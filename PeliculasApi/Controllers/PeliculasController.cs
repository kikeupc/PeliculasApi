...
namespace PeliculasApi.Controllers
{
    ...
    public class PeliculasController : ControllerBase
    {
        ...
        public readonly string contenedor = "peliculas";
        ...
        public async Task<ActionResult<PeliculasIndexDTO>> Get()
        {
            ...
            var proximosEstreno = await context.Peliculas
            ...
            resultado.FuturosEstrenos = mapper.Map<List<PeliculaDTO>>(proximosEstreno);
        ...
        public async Task<ActionResult<List<PeliculaDTO>>> Filtrar([FromQuery] FiltroPeliculasDTO filtroPeliculasDTO)
        {
            ...
            if (!string.IsNullOrEmpty(filtroPeliculasDTO.CampoOrdenar))
            {
                ...
                try
                {
                    ...
                    //peliculasQueryable = peliculasQueryable.OrderBy("titulo descending");
                }
                catch (Exception ex)
                {
